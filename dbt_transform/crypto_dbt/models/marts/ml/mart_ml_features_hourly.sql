...
microstructure_lagged AS (
    ...
    SELECT
        *,
        ...
        LAG(COALESCE(quote_volume_zscore_24h, quote_volume_zscore_calc_24h), 1)
            OVER symbol_time AS volume_zscore_24h_lag_1h,
